...
Original file is located at
    https://colab.research.google.com/drive/1eLlYWyHEV5_FYW4Z8UJv9S2vSd3kCwh6
...
inter = str(regressor.intercept_)
print('y-Intercept of the multiple linear regression equation : ' + inter)

slope = str(regressor.coef_)
print('Slope of the multiple linear regression equation : ' + slope)

import pandas as pd
d = {
    'slopes' : ['- 32174.2645862','+28314.47160234','+80960.8365489','+6428.24177905','+3413.70406639','+49942.35152741','+36835.82051685','+21903.68879982','+116003.40529456','+76073.5117404','+25375.83805414','-72994.52529983','+7676.57141888','+78057.84710672','-17254.48220907','+18909.70160034','-10301.37920458','+4182.48580611','+17081.43533197'],
    'ind_vars' : ['x1', 'x2', 'x3', 'x4', 'x5', 'x6', 'x7', 'x8', 'x9', 'x10', 'x11', 'x12', 'x13', 'x14', 'x15', 'x16', 'x17', 'x18', 'x19']
    }
...
# MLR equation
print('Multiple Linear equation : ')
print("\033[1m" + 'y = ' + inter + ' ' + "\033[1m" , end = '')
for ind in s.index:
  a = str(s['slopes'][ind])
  b = str(s['ind_vars'][ind])
  k = a + '*' + b
  print(k, end = '')
...
print('Linear regression lines and scatter plot of data points : ')
...
# let's drop price and keep first line features, then put those features inside the model and estimate the price!
